...
player::player(const String& _n, int h_p, int Defence, DA <Simple_Attack>& other ,const special_attack& others) : only{ others }, moves{ other }, character{ _n, h_p, Defence }, score{ 0 }, facing{true} {}
