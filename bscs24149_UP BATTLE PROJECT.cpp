...
int main(){
	...
	enemy e("kuta", 70, 0, "falto", 1, "assests/little(attack).png", "assests/gorilla(damage).png", 3);
	e.LoadTextureFromFile("assests/little(idle).png");
	/*enemy en("kuta", 70, 0, "falto", 1, "assests/little(attack).png", "assests/gorilla(damage).png", 3);
	en.LoadTextureFromFile("assests/little(idle).png");*/
	enemy e2("kuta2",200, 0, "falto2",3, "assests/fighter3(J).png", "assests/fighter3(D).png", 7);
	e2.LoadTextureFromFile("assests/fighter3.png");e2.SetSpeed(2.0f);
	DA<enemy> e1(e);
	//DA<enemy> e3(en);e3.add(en);e3.add(en);
	e1.add(e); e1.add(e);
	...
	special_attack s2(100, "Blast",20, "assests/fighter2(B).png");
	...
	special_attack s3(100, "Blast",20, "assests/fighter3(L).png");
	...
	DA <level> l1(l);
	l1.add(level(e1, b1, "assests/level.png"));
	try {
