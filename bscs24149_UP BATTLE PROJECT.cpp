...
int main(){
	...
	DA <Simple_Attack> a (Simple_Attack(1, "Punch", "assests/fighter1(J).png"));
	a.add(Simple_Attack(1, "Kick", "assests/fighter1(K).png"));
	special_attack s(100,"Blast",2,"assests/fighter(L).png");
	...
	DA <Simple_Attack> a2(Simple_Attack(1, "Punch", "assests/fighter2(M).png"));
	a2.add(Simple_Attack(1, "Kick", "assests/fighter2(N).png"));
	special_attack s2(100, "Blast", 2, "assests/fighter2(B).png");
